...
export const NotificationDefaultBubbleView: FC<NotificationDefaultBubbleViewProps> = props =>
{
    ...
    return (
        <LayoutNotificationBubbleView animated={ true } onClose={ onClose } gap={ 2 } alignItems="center" onClick={ event => (item.linkUrl && item.linkUrl.length && OpenUrl(item.linkUrl)) } { ...rest }>
