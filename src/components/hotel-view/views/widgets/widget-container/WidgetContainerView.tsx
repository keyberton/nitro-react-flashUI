  	...
  	return (
        <div className="widgetcontainer widget d-flex flex-row overflow-hidden">
            ...
            <div className="d-flex flex-column align-self-center">
                ...
                <button style={ { minWidth: '178px' } } className="btn btn-sm btn-illumina fs-7 p-0 align-self-start px-4 mt-auto" onClick={ event => OpenUrl(getOption('btnLink')) }>{ LocalizeText(`landing.view.${ getOption('texts') }.button`) }</button>
            </div>
        </div>
  	);
}
